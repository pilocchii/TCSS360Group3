...
public class Volunteer extends User {
	...
	public class jobBeginsTooSoonToUnvolunteerException extends Exception {
        public jobBeginsTooSoonToUnvolunteerException() {}
        public jobBeginsTooSoonToUnvolunteerException(String message) { super(message); }
	}

    public class jobDateHasPassedException extends Exception {
        public jobDateHasPassedException() {}
        public jobDateHasPassedException(String message) { super(message); }
    }
